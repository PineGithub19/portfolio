...
const ProfileInfo: React.FC<{
  ...
  return (
    <motion.div
      className="absolute top-1/2 left-1/2 translate-x-[-50%] translate-y-[-50%] flex flex-col items-center md:items-start md:flex-row"
    ...
    >
      ...
      <div className="sm:ml-8 text-white flex flex-col items-center md:items-start">
        <h1 className="mt-4 md:mt-0 text-4xl xl:text-5xl">Thái Huyễn Tùng</h1>
        <p className="my-4 text-2xl font-light">Fullstack Developer</p>
        <p className="text-lg text-justify w-70 sm:w-80 md:w-100 lg:w-124 xl:w-170 xl:text-xl font-light">
